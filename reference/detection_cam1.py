#!/usr/bin/env python3
"""
rpicam-vid + OpenCV를 이용한 간단한 모션 감지 (리팩토링 버전) - Camera 1
    ...
    def _get_default_config(self) -> dict:
        ...
        return {
            ...
            'recording': {
                ...
                'output_dir': 'videos/motion_events/cam1'  # cam1 디렉토리로 변경
            },
            'debug': {
                'output': DEBUG_OUTPUT,
...
class VideoRecorder:
    ...
    def __init__(self, output_dir: str = "videos/motion_events/cam1", 
    ...
    def start_recording(self, camera_id: int) -> Optional[Path]:
        ...
        output_path = daily_dir / f"motion_event_cam1_{timestamp}.mp4"  # 날짜 폴더 안에 저장
...
class MotionDetectionSystem:
    ...
    def _print_startup_info(self):
        """시작 정보 출력"""
        print(f"Motion Detection System Initialized - Camera 1")
...
def main():
    """메인 함수"""
    print("Motion Detection System - Camera 1")
    print("=" * 40)
